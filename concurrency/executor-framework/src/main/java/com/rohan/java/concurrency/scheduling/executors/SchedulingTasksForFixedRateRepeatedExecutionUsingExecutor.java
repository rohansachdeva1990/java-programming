...
public class SchedulingTasksForFixedRateRepeatedExecutionUsingExecutor {
    ...
    public static void main(String[] args) throws Exception {
        ...
        ScheduledFuture<?> scheduledFuture1 = scheduledExecutorService.scheduleAtFixedRate(new ScheduledTaskB(1000), 4, 2, TimeUnit.SECONDS);
        ScheduledFuture<?> scheduledFuture2 = scheduledExecutorService.scheduleAtFixedRate(new ScheduledTaskB(3000), 4, 2, TimeUnit.SECONDS);
